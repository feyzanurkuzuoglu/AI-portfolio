...
architecture_config = [
    ...
    (3,512,1,1),
    "M",
    # list: tuples and then last integers represents number of repeats
...
class Yolov1(nn.Module):
    def __init__(self, in_channels=3, **kwargs):
        ...
        #YOLOv1 modelinin ilk versiyonunun temel mimarisi, Darknet adı verilen bir konvolüsyonel ağ yapısına dayanır.
        # Darknet, YOLO'nun özellik çıkarma (feature extraction) kısmını üstlenir.
    ...
    def _create_fcs(self, split_size, num_boxes, num_classes):
        ...
        return nn.Sequential(
            ...
            nn.Dropout(0.0),
            nn.LeakyReLU(0.1),
            nn.Linear(496, S * S * (B * 5 + C)), # (S, S, 30) where C+B*5 = 30
        )
